@ST_15841 @tagtagtag @this_is_story_tag
...
@SC_67032 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_67033 @third_scenario_tag
...
@SC_67034 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_67035 @fifth_scenario_tag
